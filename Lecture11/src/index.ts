...
class getChaiType {
  ...
  constructor(chaiType: string, numberOfTea: number) {
...
class getChaiBhai {
  readonly Chai: string;

  constructor(Chai: string) {
    this.Chai = Chai;
  }
}
...
console.log(u4);
//u4.Chai = "cardamon Chai" // isko mai update nahi kar sakta okkh! bcz ye readonly property hai!..
